  ...
  -- stylua: ignore
    miniclue.setup({
      ...
      window = {
        ...
        config = {
          width = 'auto',
          title = ' Clues (<C-d> / <C-u> to scroll) ',
          title_pos = 'center', -- Can be 'left', 'center', or 'right'
          border = 'rounded',   -- Title requires a border to render correctly
        },
      },
      clues = {
...
-- NOTE: This messes things up on Ubuntu 18.04 machines, let's use lazygit instead
